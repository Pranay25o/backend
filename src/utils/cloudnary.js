...
// Configuration
    cloudinary.config({ 
        ...
        api_secret:process.env.CLOUDDINARY_CLOUD_SECRET // Click 'View API Keys' above to copy your API secret
    });
...
const uplaodOnCloudinary=async(localFilePath)=>{
    try {
       ...
       const response= await cloudinary.uploader.upload(localFilePath,{
        ...
        // console.log("files are successfully uplaoded",response.url);
        // return response;
